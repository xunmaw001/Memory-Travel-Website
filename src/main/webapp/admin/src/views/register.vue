  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255,255,255,.5);borderRadius:10px">
        <h1 class="h1" style="color:rgba(252, 252, 252, 1);fontSize:30px;">记忆旅游网站注册</h1>
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("http://codegen.caihongy.cn/20210114/f1e8269781a44418ae72a5e3a025e1d4.jpg");
		height: 100vh;
