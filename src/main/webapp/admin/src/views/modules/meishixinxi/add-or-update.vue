          ...
          <el-form-item class="input" v-if="ruleForm.faburiqi" label="发布日期" prop="faburiqi">
              <el-input v-model="ruleForm.faburiqi" 
                placeholder="发布日期" readonly></el-input>
                                                                                ...
                                                                                <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="餐馆推荐" prop="canguantuijian">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="餐馆推荐"
                  v-model="ruleForm.canguantuijian" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.canguantuijian" label="餐馆推荐" prop="canguantuijian">
                    <span>{{ruleForm.canguantuijian}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.meishijieshao = true;
            continue;
	            	            ...
	            	            if(o=='canguantuijian'){
            this.ruleForm.canguantuijian = obj[o];
	    this.ro.canguantuijian = true;
            continue;
          }
	            	            if(o=='faburiqi'){
