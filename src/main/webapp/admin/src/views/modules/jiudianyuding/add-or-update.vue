          ...
          <el-form-item class="input" label="预订天数" prop="yudingtianshu">
              <el-input v-model="ruleForm.yudingtianshu" 
                placeholder="预订天数" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="预订金额" prop="yudingjine">
            <el-input v-model="yudingjine"
                placeholder="预订金额" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.yudingjine" label="预订金额" prop="yudingjine">
              <el-input v-model="ruleForm.yudingjine" 
                placeholder="预订金额" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
