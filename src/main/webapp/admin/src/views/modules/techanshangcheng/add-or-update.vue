          ...
          <el-form-item class="input" label="特产名称" prop="techanmingcheng">
              <el-input v-model="ruleForm.techanmingcheng" 
                placeholder="特产名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="特产分类" prop="techanfenlei">
          <el-input v-model="ruleForm.techanfenlei" 
              placeholder="特产分类" clearable  :readonly="ro.techanfenlei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="特产分类" prop="techanfenlei">
              <el-input v-model="ruleForm.techanfenlei" 
                placeholder="特产分类" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="24">  
...
export default {
  data() {
	...
	price : false,
            ...
            ruleForm: {
                  ...
                  techanfenlei: [
                            { required: true, message: '特产分类不能为空', trigger: 'blur' },
                                    	                                                              ],
                  tupian: [
                                    	                                                              ],
                  guige: [
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.techanmingcheng = true;
            continue;
	            	            ...
	            	            if(o=='techanfenlei'){
            this.ruleForm.techanfenlei = obj[o];
	    this.ro.techanfenlei = true;
            continue;
          }
	            	            if(o=='tupian'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `techanshangcheng/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.techanshangchengCrossAddOrUpdateFlag = false;
                  this.parent.search();
