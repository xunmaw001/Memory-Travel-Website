...
import center from '@/views/center'
    ...
    import techanshangcheng from '@/views/modules/techanshangcheng/list'
    import orders from '@/views/modules/orders/list'
    import jiudianyuding from '@/views/modules/jiudianyuding/list'
    import discusstechanshangcheng from '@/views/modules/discusstechanshangcheng/list'
...
const routes = [{
	...
	path: '/meishixinxi',
        ...
        component: meishixinxi
          ...
          ,{
	path: '/techanshangcheng',
        name: '特产商城',
        component: techanshangcheng
      }
          ,{
        path: '/orders/:status',
        name: '订单管理',
	...
	path: '/jiudianyuding',
        ...
        component: jiudianyuding
          ...
          ,{
	path: '/discusstechanshangcheng',
        name: '特产商城评论',
        component: discusstechanshangcheng
      }
          ,{
	path: '/config',
        name: '轮播图管理',
